...
![not found](pet_not_found.png)

- Find information about pets by status

![status](find_by_status.png)

- A new user was added

![user](create_user.png)

- "userid", "username", "password" variables created

![variables](user_variables.png)
